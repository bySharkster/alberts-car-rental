...
import StepErrorIcon from "./StepErrorIcon";
    ...
    >
      <motion.div
        variants={{
          inactive: {
            scale: 1,
            backgroundColor: hasError ? "#fee2e2" : "#222",
            color: hasError ? "#ef4444" : "#a3a3a3",
          },
          active: {
            scale: 1,
            backgroundColor: hasError ? "#fee2e2" : "#00d8ff",
            color: hasError ? "#ef4444" : "#00d8ff",
          },
          complete: {
            scale: 1,
            backgroundColor: hasError ? "#fee2e2" : "#00d8ff",
