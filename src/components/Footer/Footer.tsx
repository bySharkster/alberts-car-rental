    ...
    <div className="container mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link href="/fleet" className="text-white/80 hover:text-white transition-colors cursor-pointer">Our Fleet</Link></li>
            ...
            <li><Link href="/reservations" className="text-white/80 hover:text-white transition-colors cursor-pointer">Reservations</Link></li>
            ...
            <li><Link href="/about-us" className="text-white/80 hover:text-white transition-colors cursor-pointer">About Us</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link href="#faqs" className="text-white/80 hover:text-white transition-colors cursor-pointer">FAQs</Link></li>
            <li><Link href="/contact" className="text-white/80 hover:text-white transition-colors cursor-pointer">Contact Us</Link></li>
            {/* <li><Link href="#" className="text-white/80 hover:text-white transition-colors cursor-pointer">Roadside Assistance</Link></li> */}
            <li><Link href="/terms" className="text-white/80 hover:text-white transition-colors cursor-pointer">Terms & Conditions</Link></li>
            <li><Link href="/privacy" className="text-white/80 hover:text-white transition-colors cursor-pointer">Privacy Policy</Link></li>
            <li><Link href="/cancellation" className="text-white/80 hover:text-white transition-colors cursor-pointer">Cancellation Policy</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start">
              ...
              <span className="text-white/80">Mon-Fri: 8AM-8PM<br />Sat-Sun: 9AM-6PM</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="pt-8 border-t border-white/20">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm mb-4 md:mb-0">© 2025 Albert Car Rental. All rights reserved.</p>
