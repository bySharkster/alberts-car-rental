...
export default function Header() {
  ...
  return (
    <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm fixed">
      <nav
        className="mt-2 relative max-w-[85rem] w-full bg-white border border-gray-200 rounded-[36px] mx-4 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-8 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Global"
      >
