    ...
    >
      ...
      <div className="absolute bottom-0 left-0 p-8">
        ...
        <p className="text-lg text-white/90">
          To lead the transformation of the car rental industry by embracing
          sustainable practices, cutting-edge technology, and customer-centric
          services that redefine mobility for future generations.
        </p>
      </div>
    </AnimatedSection>
  );
