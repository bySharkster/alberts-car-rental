      ...
      <div className="max-w-3xl mx-auto">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="border-b border-gray-200">
            ...
            <AccordionContent className="text-[#464648] pb-4">
        ...
        <div className="mt-12 text-center">
          ...
          <Button className="bg-[#024f7d] hover:bg-[#026bad] text-white px-8 py-6 text-lg !rounded-button whitespace-nowrap cursor-pointer">
            Contact Support
          </Button>
        </div>
      </div>
